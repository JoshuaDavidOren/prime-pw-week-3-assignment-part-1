...
console.log('Number of fovorite foods:', favoriteFood.length);
...
favoriteFood.push('Cheese burger');
console.log('Added my fifth fovorite food,', favoriteFood);
...
console.log('Removed fifth favorite food', removedFood);
console.log('My fovorite food list now reads', favoriteFood);
...
favoriteFood.unshift('Smoothie');
console.log( "Just remembered I love smoothies and their heathy:", favoriteFood);
